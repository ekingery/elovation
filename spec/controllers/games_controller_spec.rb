    ...
    it "returns a json response" do
      Timecop.freeze(Time.now) do
        ...
        json_data.should == {
          ...
          "ratings" => [
            {"player" => 
              {"name" => player1.name, "email" => player1.email, "twitter" => nil, "venue" => nil} , "value" => 1003},
            {"player" => 
              {"name" => player2.name, "email" => player2.email, "twitter" => nil, "venue" => nil} , "value" => 1002},
            {"player" => 
              {"name" => player3.name, "email" => player3.email, "twitter" => nil, "venue" => nil} , "value" => 1001}
          ],
          "results" => [
